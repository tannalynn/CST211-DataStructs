...
public:
	...
	void BreadthFirst(void(*visit)(const V & data));
			//Checks if the list is empty
	bool IsEmpty() const;
			//returns a copy of the vertices in the graph
...
***************************************************************************************************/
template <typename V, typename E>
Graph<V, E>::Graph(const Graph<V, E> & copy):m_count(0)
{
	*this = copy;
}
/***************************************************************************************************
...
/***************************************************************************************************
*	Purpose: gets the vertices
*
*	Entry: none
*
*	Exit: returns the list of vertices in graph
***************************************************************************************************/
template <typename V, typename E>
